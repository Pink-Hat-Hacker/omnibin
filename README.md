...
## Dashboard Features
- **Live tab**: Real-time camera stream, classification results,
  confidence scores, confirm/correct button, recent items feed
- **Admin tab**: Device status, accuracy by category, 24h activity
  timeline, donut chart breakdown, full classification history

## Pi Features
- **Calibration**: Calibration file the sets garbage bin at correct orientation and tests stepper motors
- **Modular**: Seperate classes for camera, motors, and classification
